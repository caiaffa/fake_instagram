defmodule FakeInstagram.PostsTest do
  use FakeInstagram.DataCase

  alias FakeInstagram.Posts

  describe "photos" do
    alias FakeInstagram.Posts.Photo
  ...
  describe "photo_commentstext" do
    alias FakeInstagram.Posts.Comments
    ...
    test "list_photo_commentstext/0 returns all photo_commentstext" do
      comments = comments_fixture()
      assert Posts.list_photo_commentstext() == [comments]
    end
  ...
  describe "photo_comments" do
    alias FakeInstagram.Posts.Comment
